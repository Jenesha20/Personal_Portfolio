          ...
          <Col md={7}>
            <Fade duration={3000}>
              <p className="home-about-body">
                My name is <b className="purple">S JENESHA MALAR </b> 
                  and I am a <b className="purple">ARTIFICIAL INTELLIGENCE AND DATA SCIENCE </b> 
                    student at <b className="purple">Kongu Engineering College </b>
                      in Erode, Tamil Nadu .
                <br />
                <br />
                ...
                I also have experience working with frameworks and libraries such as &nbsp;
                  ...
                  <b className="purple">
                    {" "}
                    NodeJS, ReactJS, OpenCV, Pandas, NumPy, and PowerBI .{" "}
                  </b>
                <br />
                <br />
